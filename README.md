...
- Recommended: token/protocol addresses (`VITE_TESTNET_USDC_ADDRESS`, `VITE_TESTNET_CUSD_ADDRESS`, `VITE_TESTNET_USDM_ADDRESS`, `VITE_TESTNET_CRX_ADDRESS`, `VITE_TESTNET_MEGA_TOKEN_ADDRESS`, `VITE_TESTNET_MASTER_CHEF_ADDRESS`, `VITE_TESTNET_CRX_WETH_LP_ADDRESS`, `VITE_TESTNET_EXPLORER`, `VITE_TESTNET_CHAIN_ID_HEX`).
