...
export default function WhitelistBanner({ href = DEFAULT_WHITELIST_URL }) {
  return (
    ...
    >
      <div className="w-full bg-[#0c2f4f] text-slate-50 px-4 py-2 flex items-center justify-center gap-2 sm:gap-3 text-[11px] sm:text-sm font-semibold tracking-[0.18em] uppercase border border-[#0ff5ff] shadow-[0_0_18px_rgba(15,245,255,0.32)] hover:shadow-[0_0_22px_rgba(15,245,255,0.45)] hover:brightness-[1.08] transition">
