...
export default function WhitelistBanner({ href = DEFAULT_WHITELIST_URL }) {
  return (
    ...
    >
      <div className="w-full bg-[#041a2e] text-slate-50 px-4 py-2 flex items-center justify-center gap-2 sm:gap-3 text-[11px] sm:text-sm font-semibold tracking-[0.18em] uppercase shadow-[0_1px_0_rgba(0,0,0,0.25)] hover:brightness-[1.08] transition">
