...
const DEFAULT_CURRENTX_ADDRESS = env.VITE_CURRENTX_ADDRESS || "";
const DEFAULT_CURRENTX_VAULT_ADDRESS = env.VITE_CURRENTX_VAULT_ADDRESS || "";
const DEFAULT_LP_LOCKER_V2_ADDRESS = env.VITE_LP_LOCKER_V2_ADDRESS || "";
