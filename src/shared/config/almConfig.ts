...
export const ALM_ADDRESSES = {
  ALM: env.VITE_ALM_ADDRESS || "0x0F68eC09073d31CF49bEe8ACeDd5aE653edD6AEe",
  NFPM: env.VITE_ALM_NFPM_ADDRESS || "0xA02E90A5F5eF73c434f5A7E6A77E6508f009cB9D",
  STRATEGY_REGISTRY:
    env.VITE_ALM_STRATEGY_REGISTRY_ADDRESS || "0x430484a800594436ecF342419c81a6ED3A297A52",
  ORACLE: env.VITE_ALM_ORACLE_ADDRESS || "0x64FE75a77633eC862c771e033b6Acf22269B4Fe0",
